...
| 2 | [GatewayClass and Gateway, in depth](02-gatewayclass-and-gateway-in-depth.md) | Listener Distinctiveness, TLS modes (Terminate vs Passthrough), and the `addresses` field | [Hands-on](labs/02-gatewayclass-gateway-lab.md) |
...
| 6 | [ListenerSet](06-listenerset.md) | Letting teams self-serve their own Listeners on a shared Gateway, beyond the 64-Listener limit | |
